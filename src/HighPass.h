#ifndef _HIGHPASS__H_
#define _HIGHPASS__H_

#include "TimeStep.h"
#include "Integrator.h"

/**
 *  \headerfile HighPass.h
 *  \class HighPass
 *  \brief Arduino class to implement 1<sup>st</sup>-order high-pass filter.
 *  \author Thomas W. Rackers, Ph.D.
 *  \version 1.0.0
 *  
 *  This class performs a numerical first-order high-pass filtering of data
...
class HighPass
{
  ...
  public:
     ...
     *  \brief Constructor.
     *  
     *  \details The constructor creates an instance of a HighPass object with
     ...
     */
    HighPass(const TimeStep& dt, double tau, double yInitial = 0.0);
